							...
							<div class="card-body" >
                            	...
                            	@endif
	                            	...
	                            	<div class="form-group row">
	                            		<div class="col-md-12">
	                            			<label  class="text-body">Nama TahunAjaran</label>
	                            			<fieldset class="form-group mb-3">
	                            				<input type="hidden" name="id" id="id" value="{{ request()->id }}">
	                            				<input type="text" class="form-control" id="TahunAjaran" name="TahunAjaran" placeholder="Masukan Tahun Ajaran" value="{{ ($tahunajaran) ? $tahunajaran->TahunAjaran : '' }}" required="" >
	                            			</fieldset>
