...
class RolesController extends Controller
{
    ...
    public function Form($id = null)
    {
        ...
        // PermissionRoles
        $userrole = UserRole::where('userid','=', Auth::user()->id)->first();

        $oMenu = array();
        $data = "hai ini data";
        $permissionrole = Permission::selectRaw("permission.*,COALESCE(permissionrole.roleid,'') roleid")
                        ->leftJoin('permissionrole', function ($value) use($id){
    ...
    public function deletedata(Request $request)
    {
    	...
    	$permissionrole = PermissionRole::where('roleid','=',$request->id)->get();
